...
const VALIDATOR_CONSUMABLE_SLOTS: String = "res://scripts/validators/ValidatorConsumableSlots.gd"
...
const INTERCEPTOR_HIGH_LATENCY: String = "res://scripts/action_interceptors/InterceptorHighLatency.gd"
