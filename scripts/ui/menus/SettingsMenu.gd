...
@onready var frame_rate_limit_slider: FrameRateLimitSlider = %FrameRateLimitSlider
...
@onready var display_fps_check_button: CheckButton = %DisplayFPSCheckButton
...
func _ready():
	...
	display_fps_check_button.toggled.connect(_on_display_fps_button_toggled)
	...
	frame_rate_limit_slider.value_changed.connect(_on_frame_rate_limit_slider_changed)
	#
...
func _save_settings() -> void:
	...
	Global.user_settings_data.settings_frame_rate_limit = frame_rate_limit_slider.get_frame_rate_limit()
	...
	Global.user_settings_data.settings_display_fps = display_fps_check_button.button_pressed
...
func populate_menu() -> void:
	...
	frame_rate_limit_slider.set_frame_rate_limit_no_signal(Global.user_settings_data.settings_frame_rate_limit)
	# mute in background
	...
	display_fps_check_button.set_pressed_no_signal(Global.user_settings_data.settings_display_fps)
...
func _on_frame_rate_limit_slider_changed(_value: float) -> void:
	var frame_rate_limit: int = frame_rate_limit_slider.get_frame_rate_limit()
	Global.user_settings_data.settings_frame_rate_limit = frame_rate_limit
...
func _on_display_fps_button_toggled(toggle: bool) -> void:
	Global.user_settings_data.settings_display_fps = toggle
