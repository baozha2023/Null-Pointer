...
func perform_action() -> void:
	...
	for action_interceptor_processor in action_interceptor_processors:
		...
		# get an energy rng
		var rng_name: String = action_interceptor_processor.get_shadowed_action_values("rng_name", "rng_energy_cost")
		var rng_energy_cost: RandomNumberGenerator = Global.player_data.get_player_rng(rng_name)
